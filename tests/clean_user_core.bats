...
@test "clean_user_essentials keeps MacKit runtime logs while cleaning other user logs" {
    mkdir -p "$HOME/Library/Logs/mackit"
    mkdir -p "$HOME/Library/Logs/OtherApp"
    touch "$HOME/Library/Logs/mackit/operations.log"
...
[[ -d "$HOME/Library/Logs/mackit" ]]
[[ -f "$HOME/Library/Logs/mackit/operations.log" ]]
