#!/bin/bash
# MacKit - Timeout Control
# Command execution with timeout support

set -euo pipefail

# Prevent multiple sourcing
if [[ -n "${MACKIT_TIMEOUT_LOADED:-}" ]]; then
    return 0
fi
readonly MACKIT_TIMEOUT_LOADED=1
...
#
# Environment:
#   MK_DEBUG - Set to 1 to enable debug logging to stderr
#
