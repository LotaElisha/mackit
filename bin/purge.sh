...
start_purge() {
    ...
    export MACKIT_CURRENT_COMMAND="purge"
...
# Show help message
show_help() {
    echo -e "${PURPLE_BOLD}MacKit Purge${NC}, Clean old project build artifacts"
    echo ""
    echo -e "${YELLOW}Usage:${NC} mk nuke [options]"
    echo ""
    ...
    for arg in "$@"; do
        case "$arg" in
            ...
            *)
                ...
                echo "Use 'mk nuke --help' for usage information"
                exit 1
                ;;
        esac
    done
