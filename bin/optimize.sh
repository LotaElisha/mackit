...
run_system_checks() {
    ...
    unset MACKIT_SECURITY_FIXES_SHOWN
    unset MACKIT_SECURITY_FIXES_SKIPPED
    echo ""
    ...
    if [[ "${MACKIT_SECURITY_FIXES_SKIPPED:-}" != "true" ]]; then
        echo ""
    fi
...
main() {
    ...
    export MACKIT_CURRENT_COMMAND="optimize"
