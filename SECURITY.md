...
MacKit is a local system maintenance tool. It includes high-risk operations such as cleanup, uninstall, optimization, and artifact removal. We treat safety boundaries, deletion logic, and release integrity as security-sensitive areas.

## Reporting a Vulnerability

Please report suspected security issues privately.

- Email: `hilotaelisha@gmail.com`
- Subject line: `MacKit security report`
...
- MacKit version and install method
- macOS version
...
- False negatives where MacKit refuses to clean something
...
## Security-Focused Areas in MacKit
